...
class Yolov7Publisher(rclpy.node.Node):
    def __init__(self):
        ...
        self.declare_parameter('weights_path', '/home/kong/ws/yolo_weights/yolov7-w6-pose.pt', weights_path_des)
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        save_string_to_csv('/home/kong/ws/obj_res/'+img_id, detections[0].tolist())
